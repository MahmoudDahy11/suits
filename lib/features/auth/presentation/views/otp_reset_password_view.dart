...
class OtpResetPasswordView extends StatefulWidget {
  const OtpResetPasswordView({super.key});

  @override
  State<OtpResetPasswordView> createState() => _OtpResetPasswordViewState();
}

class _OtpResetPasswordViewState extends State<OtpResetPasswordView> {
